...
build: clean dist/index.html dist/bundle.js dist/assets css ## Compile the app

css:
	sass app/:dist/assets/css --style compressed --update
	
css-watch:
	sass app/:dist/assets/css --style compressed --watch
