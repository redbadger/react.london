...
function Banner({ page }) {
  if (page === 'Community') {
    return (
      <div className="SiteFooter__banner SiteFooter__conference block">
        <h2 className="SiteFooter__banner-title">React London 2017</h2>
        <p>
          <span className="text-background">
            We hosted the first React conference
            <br />
            in London in March 2017.
          </span>
        </p>
        <a className="SiteFooter__banner-cta" href="/conference" target="_blank" rel="noopener">
          <span className="text-background">Find out more</span>
        </a>
      </div>
    );
  }
  return (
    <div className="SiteFooter__banner SiteFooter__community block">
      <h2 className="SiteFooter__banner-title">React London Meetup</h2>
      <p>
        <span className="text-background">Looking for our meetups?</span>
      </p>
      <a className="SiteFooter__banner-cta" href="/community" target="_blank" rel="noopener">
        <span className="text-background">Find out more</span>
      </a>
    </div>
  );
...
function footerBlerb(page) {
  if (page === 'Community') {
    return (
      'Red Badger runs the React London meetups to help chart what’s possible,' +
      ' and give the community a place to share discoveries.'
    );
  }
  return (
    'Red Badger is running the React London Conference to help chart what’s' +
    ...
    <div className="SiteFooter__content block">
      <div className="SiteFooter__content-container content">
        <div className="SiteFooter__blerb">
          <object className="SiteFooter__badger icon-Badger" />
